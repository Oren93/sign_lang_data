...
async def upload_video(
    ...
    try:
        ...
        db.add(db_video)
        db.flush()  # Do not commit yet, just assign an ID
        ...
        # Update the Video entry with the file path and FPS
        ...
        # Safely handle temp_file_path and output_path if they were initialized
