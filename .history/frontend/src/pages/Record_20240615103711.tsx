...
const Record: React.FC = () => {
  ...
  const [isRecording, setIsRecording] = useState<boolean>(false); // New state for brightness
  ...
  const startRecording = () => {
    setRecording(true);
    setIsRecording(true); // Make video brighter
    setCapturedChunks([]);
  ...
  const handleStopRecording = () => {
    setRecording(false);
    setIsRecording(false); // Reset brightness
