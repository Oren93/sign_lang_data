...
const Record: React.FC = () => {
  ...
  const startRecording = () => {
    setRecording(true);
    setIsRecording(true);
    setCapturedChunks([]); // Clear capturedChunks before starting a new recording
  ...
  const uploadVideo = async (videoBlob: Blob) => {
    ...
    const uniqueFilename = `video_${Date.now()}.webm`; // Unique filename with timestamp
