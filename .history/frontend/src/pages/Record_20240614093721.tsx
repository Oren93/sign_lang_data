...
const Record: React.FC = () => {
  ...
  const fetchWords = async () => {
    try {
      const response = await fetch('http://<your-backend-url>/words');
  ...
  const uploadVideo = async (videoBlob: Blob) => {
    ...
    try {
      const response = await fetch('http://<your-backend-url>/submit', {
        method: 'POST',
        body: formData,
      });
      const data = await response.json();
        ...
        {videoUrl && (
          <div className={styles.videoContainer}>
            ...
            <div className={styles.buttonContainer}>
              ...
              <button className={styles.repeatButton} onClick={
