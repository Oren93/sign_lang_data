  ...
  return (
    <main className={styles.main}>
      <section className={styles.section}>
        ...
        <button className={styles.button} onClick={generateRandomWord}>Next Word</button>
        <div>
          <Webcam audio={true} ref={webcamRef} />
        </div>
        <div>
          {recording ? (
            <button className={styles.button} onClick={handleStopRecording}>Stop Recording</button>
          ) : (
            <button className={styles.button} onClick={handleStartRecording}>Start Recording</button>
          )}
        </div>
        {videoUrl && (
          <div>
