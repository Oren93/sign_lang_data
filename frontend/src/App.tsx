...
import ThankYou from './pages/ThankYou'; // Import the Thank You page
...
const App: React.FC = () => {
  ...
  return (
    <div>
      {location.pathname !== '/record' && <Header />}
      <Routes>
        ...
        <Route path="/thank-you" element={<ThankYou />} /> {/* Add the new route */}
      </Routes>
      {location.pathname !== '/record' && <Footer />}
    </div>
  );
};
